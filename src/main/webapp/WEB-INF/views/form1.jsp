                ...
                <div class="block-content collapse in">
                    <div class="tab-pane" id="tab3">
                        ...
                        <div class="span12">
                            ...
                            <input id="hide_dataSource" type="hidden" value="">
                        </div>
...
$(document).ready(function(){
    ...
    function DataSourceInit(btn,dataSourceName,dataSourceId,dataSourceDesc){
        this.btn = btn;
    ...
    table.on( 'select', function ( e, dt, type, indexes ) {
        ...
        var dataSourceId = rowData[0].dataSourceId;
        $("#hide_dataSource").val(dataSourceId);
    } )
    ...
    $("#next").on("click",function(){
        var dataSourceId = $("#hide_dataSource").val();
